...
public final class NavigationController {
    ...
    public enum JumpCommand { NONE, ONCE, CONTINUOUS }

    public record Observation(Vec3 position, Vec3 velocity, boolean grounded, boolean inWater,
                              boolean horizontalCollision, int air, int hunger) {}

    public record WaypointState(Vec3 target, MovementType movement, boolean sprintRequested,
