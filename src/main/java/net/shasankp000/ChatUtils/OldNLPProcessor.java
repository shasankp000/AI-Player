...
// Keeping this code around for a reason.

public class OldNLPProcessor {
    ...
    public static final Map<String, String> INTENT_KEYWORDS = Map.<String, String>ofEntries(
            ...
            Map.entry("great", "GENERAL_CONVERSATION"),
            Map.entry("wow", "GENERAL_CONVERSATION"),
            Map.entry("marvelous", "GENERAL_CONVERSATION"),
            Map.entry("fascinating", "GENERAL_CONVERSATION"),
            Map.entry("good", "GENERAL_CONVERSATION"),
            Map.entry("so", "GENERAL_CONVERSATION"),
            Map.entry("let's", "GENERAL_CONVERSATION"),
            Map.entry("therefore", "GENERAL_CONVERSATION")
    );
    ...
    public static Intent recognizeIntent(String userInput) {
        ...
        for (String word : words) {
            for (Map.Entry<String, Integer> entry : KEYWORD_CONFIDENCE.entrySet()) {
                ...
                if (score >= minConfidenceThreshold) {
                    ...
                    Set<String> coordsSynonymsMap = OldNLPProcessor.SYNONYM_MAP.get("coordinates");
